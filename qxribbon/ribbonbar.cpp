...
#include "private/titlebarbuttons.h"
    ...
    : QMenuBar(parent)
{
	...
	auto *buttons = new TitleBarButtons(this);
    buttons->setObjectName("qt_titlebar_buttons");


    setWindowButtonGroup(buttons);

 
    buttons->syncFromWindow();
